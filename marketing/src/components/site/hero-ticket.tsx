      ...
      <div className="border-sheen relative z-10 rounded-3xl p-1.5 shadow-[0_40px_120px_-30px_rgba(0,0,0,0.9)]">
        <div className="overflow-hidden rounded-[1.35rem] border border-default bg-[#0a0a0b]">
          ...
          <div className="grid gap-6 p-6 text-left md:grid-cols-[1.1fr_0.9fr]">
            <div>
              <p className="border-l border-white/15 pl-3 text-sm italic leading-relaxed text-default">
              ...
              <div className="my-4 flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.16em] text-gray-11/70">
                <span className="h-px flex-1 bg-gray-a3" /> written by brainbox
                <span className="h-px flex-1 bg-gray-a3" />
              </div>
              <div className="flex items-center gap-2">
                <span className="rounded bg-white px-1.5 py-0.5 font-mono text-[10px] font-semibold text-black">
                  BUG
                </span>
                <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-default">
                  Billing
                </span>
              </div>
              <h3 className="mt-3 text-xl font-semibold tracking-tight text-emphasis">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-grid relative aspect-[16/10] overflow-hidden rounded-xl border border-default">
                ...
                <span className="absolute bottom-2 right-2 inline-flex items-center gap-1.5 rounded-md border border-default bg-black/70 px-2 py-1 font-mono text-[10px] text-default">
              ...
              <div className="flex flex-wrap gap-1.5">
                {chips.map((c) => (
                  <span
                    key={c}
                    className="rounded-full border border-default px-2.5 py-1 font-mono text-[10px] text-default"
                  >
                    {c}
                  </span>
                ))}

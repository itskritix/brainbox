    ...
    <section id="pricing" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
      ...
      <div className="mx-auto max-w-md">
        <div className="border-sheen relative overflow-hidden rounded-3xl p-8">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full border border-default bg-white/[0.04] px-3 py-1 font-mono text-xs text-emphasis">
            ★ Founding member
          </span>

          <div className="mt-6 flex items-end gap-1.5">
            <span className="text-5xl font-semibold tracking-[-0.03em] text-emphasis">$20</span>
            <span className="mb-1.5 text-default">/ month</span>
          </div>
          <p className="mt-1 font-mono text-xs text-default">per project</p>
          ...
          <ul className="space-y-3.5">
            {perks.map((p) => (
              <li key={p} className="flex items-start gap-3 text-sm text-emphasis">

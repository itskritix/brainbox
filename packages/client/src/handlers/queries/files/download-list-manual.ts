...
import { mapDownload } from '@brainbox/client/lib';
import { ChangeCheckResult, QueryHandler } from '@brainbox/client/lib/types';
import { DownloadListManualQueryInput } from '@brainbox/client/queries/files/download-list-manual';
import { Event } from '@brainbox/client/types/events';
import { Download, DownloadType } from '@brainbox/client/types/files';

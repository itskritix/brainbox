...
import { Node, NodeAttributes } from '@brainbox/core/registry/nodes';
import { Mention } from '@brainbox/core/types/mentions';
import { WorkspaceRole } from '@brainbox/core/types/workspaces';
